# Cavalier Egis
### Effects
*   Increases damage protection by 1 point per level (+5 points at level V)
*   Protection works against all damage types except those that bypass invulnerability
