# Curse Of Enchant
### Effects
*   Prevents adding additional enchantments to the item
*   Cannot be removed like other curses

> The item can no longer be enchanted or disenchanted.
...
Durability - Enchanting Table and Anvil
